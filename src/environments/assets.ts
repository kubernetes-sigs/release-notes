export const assets = [
  'assets/release-notes-1.18.0-alpha.4.json',
  'assets/release-notes-1.18.0-alpha.3.json',
  'assets/release-notes-1.18.0-alpha.2.json',
  'assets/release-notes-1.18.0-alpha.1.json',
